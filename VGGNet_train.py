...
def main(args):
    ...
    save_weights_path = os.path.join(save_weights_dir, 'vgg16Net.pth')
    save_full_model_path = os.path.join(save_weights_dir, 'Fullvgg16Net.pth')  # 保存整个模型
    ...
    model = vgg(num_classes=num_classes, init_weights=True)  # 定义模型
    model.to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', default=15, type=int, help='迭代轮数')
