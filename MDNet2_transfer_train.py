...
def main(args):
    ...
    #将输出信息存到文件中
    sys.stdout = Logger('./save_visualization_result/MDNet_TL.out', sys.stdout)
    sys.stderr = Logger('./save_visualization_result/MDNet_TL.err', sys.stderr)
    ...
    save_weights_path = os.path.join(save_weights_dir, 'MDNet2_transfer.pth')
    save_full_model_path = os.path.join(save_weights_dir, 'FullMDNet2_transfer.pth')  # 保存整个模型
...
if __name__ == "__main__":
    ...
    parser.add_argument('--datasets_root', default='./datasets', help='数据集的根目录\n'
