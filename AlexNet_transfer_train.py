...
def main(args):
    ...
    save_weights_path = os.path.join(save_weights_dir, 'AlexNet_transfer.pth')  # 只保存参数
    save_full_model_path = os.path.join(save_weights_dir, 'FullAlexNet_transfer.pth')  # 保存整个模型
    ...
    model_weight_path = './pre_weights/alexnet_Imagenet.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--print_train_loss', default=True, help='是否每20个epoch打印训练集损失函数')
